...
namespace Datastruc
{
    public partial class ArraySort : Form
    {
        ...
        private bool TryParseInput(out int[] arr)
        {
            ...
            {
                MessageBox.Show("Enter a valid positive integer for array size.", "Invalid size", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return false;
            }
            ...
            {
                MessageBox.Show("Enter the array elements (separated by spaces or commas).", "No elements", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return false;
            }
            ...
            {
                MessageBox.Show($"You entered {parts.Length} elements but array size is {size}. Enter at least {size} elements.", "Not enough elements", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return false;
            }
            ...
            for (int i = 0; i < size; i++)
            {
                ...
                {
                    MessageBox.Show($"Invalid number '{parts[i]}' at position {i + 1}.", "Parse error", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return false;
                }
                arr[i] = value;
            }
        ...
        private void txtElements_TextChanged(object sender, EventArgs e)
        {
            ...
            int count = Math.Min(parts.Length, size);
